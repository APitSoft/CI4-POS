<div class="container-fluid">
    <?= main_header('Keuangan ', 'Entri Pengeluaran Kas/Bank', 'Daftar Pengeluaran Kas/Bank ', 'Entri Pengeluaran Kas/Bank') ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <select id="kasbank" name="kasbank" class="form-select input-medium select2me" data-placeholder="Pilih..." onkeypress="return tabE(this,event)">
                                            ...
                                            <option value="110102">Bank BJB</option>
                                            <option value="110102">Deposito Bank</option>
                                            <option value="110102">BRI</option>
                                            <option value="110102">New Account</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <select id="tgl_bayar" name="tgl_bayar" class="form-control input-medium select2me" data-placeholder="Pilih..." onkeypress="return tabE(this,event)">
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control input-large" placeholder="" name="Nomor" id="Nomor" value="" onkeypress="return tabE(this,event)">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <select id="Cabang" name="Cabang" class="form-select input-medium select2me" data-placeholder="Pilih..." onkeypress="return tabE(this,event)">
                                            <option value="110101">PUSAT</option>
                                            <option value="110102">CAB. KRWNG</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                ...
                                <table class="table table-condensed">
                                    <tfoot>
                                        <tr>
                                            <td width="20%"><button type="button" onclick="addRow('datatable', 'pembayaran_entri_tr')" class="btn green"><i class="fa fa-plus"></i> </button>
